...
namespace ShapeSorter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Shapes with are greater than 50\n");
            ...
            IEnumerable<Circle> filteredCircles = circles.Where(circle => circle.Area < 50);
            Console.WriteLine("Circles with area less than 50\n");
            ...
            Console.ReadKey(true); //get rid of true and youll see the key you input
        }
    }
}
